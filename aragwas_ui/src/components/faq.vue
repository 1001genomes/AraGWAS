...
//            {question: "Is it possible to download the data from the AraGWAS Catalog?", answer: "Yes, we provide (or will provide?!) different ways to download the data."}, // NOT available yet
            ...
            {question: "Why are some associations scores displayed in blue?", answer: "The associations with a blue score are significant associations with a score that is higher than the permutation threshold."},
        ];
        ...
        faqs_tutorial = [
            ...
            {question: "How to download my results?", answer: "After filtering, you can get the associations you are interested in by clicking on the download button at the bottom of the filtering panel. This will generate a custom csv file with information about the associations you are interested in. You can also obtain the entire dataset of a specific study in the HDF5 format by clicking on the download button at the top right corner of the study view."},
