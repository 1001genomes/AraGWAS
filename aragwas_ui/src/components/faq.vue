...
<script lang="ts">
    ...
    export default class FAQ extends Vue {
        ...
        faqs_general = [
            ...
            {question: "How to cite the AraGWAS Catalog", html: "Matteo Togninalli,  Ümit Seren,  Jan A Freudenthal,  J Grey Monroe,  Dazhe Meng, Magnus Nordborg,  Detlef Weigel,  Karsten Borgwardt,  Arthur Korte, Dominik G Grimm<br><b>AraPheno and the AraGWAS Catalog 2020: a major database update including RNA-Seq and knockout mutation data for Arabidopsis thaliana </b><br> Nucleic Acids Research, gkz925, <a target=_blank href=https://doi.org/10.1093/nar/gkz925</a><br><br>Matteo Togninalli, Ümit Seren, Dazhe Meng, Joffrey Fitz, Magnus Nordborg, Detlef Weigel, Karsten Borgwardt, Arthur Korte, and Dominik G. Grimm <br> <b> The AraGWAS Catalog: a curated and standardized Arabidopsis thaliana GWAS catalog </b><br> Nucleic Acids Research, gkx954, <a target=_blank href=https://doi.org/10.1093/nar/gkx954>https://doi.org/10.1093/nar/gkx954</a>"},
