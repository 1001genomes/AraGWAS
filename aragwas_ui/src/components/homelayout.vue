            ...
            <div class="container">
                ...
                <div v-if="!search">
                    ...
                    <div class="banner-subtext">
                        <h5 class="white--text text-xs-center">AraGWAS is a public database catalog of <em>Arabidopsis thaliana</em> associations from published GWAS studies.</h5>
                        <br>
                        <h5 class="white--text light text-xs-center">This Database allows to search and filter for public GWAS studies, phenotypes and genes and to obtain additional meta-information.</h5>
                    </div>
                </div>
                <!--</transition>-->
                <br>
                    ...
                    <v-row class="text-xs-center white--text">
                        ...
                        <v-col xs12 md6 lg4>
                            <div class="icon-block">
                                ...
                                <h5 class="text-xs-center white--text">Meta-Analysis of Associations</h5>
                        ...
                        <v-col xs12 md6 lg4>
                            <div class="icon-block">
                                ...
                                <h5 class="text-xs-center white--text">Top Associations</h5>
