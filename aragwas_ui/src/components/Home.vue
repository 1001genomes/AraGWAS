<template>
<div>
  <div class="banner-container white--text" style="height:420px">
    <div class="container">
  ...
  <div class="section mt-4">
      ...
      <v-row class="text-xs-center">
        <v-col xs12 md6 lg3>
          <div class="icon-block">
              ...
              <a class="btn btn--large icon--left green lighten-1"><v-icon left>view_list</v-icon>GWAS studies</a>
          </div>
        </v-col>
        <v-col xs12 md6 lg3>
          <div class="icon-block">
              ...
              <a class="btn btn--large icon--left green lighten-1"><v-icon left>code</v-icon>REST API</a>
          </div>
        </v-col>
        <v-col xs12 md6 lg3>
          <div class="icon-block">
        ...
        <v-col xs12 md6 lg3>
          <div class="icon-block">
              ...
              <a class="btn btn--large icon--left green lighten-1"><v-icon left>cloud_upload</v-icon>GWAS studies</a>
          </div>
        </v-col>
      </v-row>
      <v-row class="text-xs-center">
        ...
        <v-col xs12 md6 lg3>
          <div class="icon-block">
              ...
              <a class="btn btn--large icon--left green lighten-1"><v-icon left>backup</v-icon>Submit GWAS study</a>
          </div>
        </v-col>
        <v-spacer></v-spacer>
      </v-row>
    ...
    <div class="banner-container white--text mt-5" style="height:300px">
      <v-parallax class="parallax-container" src="/static/img/ara3.jpg" height="300">
      </v-parallax>
    </div>
